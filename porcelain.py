...
def cf_component_route_capability(src_component,
    ...
    cf_directory_route_capability(src_directory, src_name, dst_directory,
                                  dst_name)
...
def cf_component_route_subdirectory(src_component, src_name, src_path,
                                    dst_component, dst_name):
